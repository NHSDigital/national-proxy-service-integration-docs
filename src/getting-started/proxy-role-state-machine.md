...
| -------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Proposed | -                | Proxy role has been created in the Validated Relationships Service (VRS) having received an online access request and is pending an approval decision by a clinician/GP.                                                                                                                     |
| Rejected | -                | An online access request has been reviewed and rejected by a clinician/GP. A `statusReason` will be recorded along with the status change to inform why.                                                                                                                                     |
